...
#define __TTINY_SHELL_KEYWORD_BUFFER      1000
extern BOOL AUTO_CMPL;
extern INT SELECTED_INDEX;
extern INT MATECHED_KEYWORD_NUM;
extern __PTSHELL_KEYWORD ppskwNode[__TTINY_SHELL_KEYWORD_BUFFER];
